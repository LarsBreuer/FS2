...
public class HelperAdapterPlayer extends CursorAdapter {
			...
			public void onClick(View v) {
				...
				if (auth_token.equals("")) {
					...
					if(server_team_id!=null) {
						...
						listPlayerData = getJsonHelper.getPlayerArray(server_team_id, player_forename, player_surename, v.getContext());
						
						if (listPlayerData.size() > 0) {
