...
public class HelperOnlineUrlJsonAsyncTask extends AsyncTask<String, Void, JSONObject> {
	...
	public HelperOnlineUrlJsonAsyncTask(Context context) {
		...
		progressDialog = ProgressDialog.show(
			...
			new DialogInterface.OnCancelListener() {
				...
				public void onCancel(DialogInterface arg0) {
					...
					HelperOnlineUrlJsonAsyncTask.this.cancel(true);
	...
	protected JSONObject queryUrlForJson(String url) {
		...
		try {
		    	try {
		    		...
		    		json = HelperOnlineJson.getJsonObjectFromUrl(url, this.timeoutConnect, this.timeoutRead);
					...
					Log.e(TAG, HelperOnlineLazy.Ex.getStackTrace(e));
